...
public:
     ...
     tree::Label* loop_start_label = nullptr;  // 当前循环开始标签
     tree::Label* loop_end_label = nullptr;    // 当前循环结束标签
     ...
     tree::Program* getTree() { return tree_root; } //return the tree from a single visit (program returns a single tree)
     /*
